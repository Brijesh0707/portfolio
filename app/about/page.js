...
>
  ...
  transition={{ delay: 0.3, duration: 0.3 }} className='flex flex-wrap gap-4'>
    ...
    >
    <SwiperSlide>
      <div className='w-[300px] card_body rounded-md pb-[70px]'>
        <div className='image w-[300px] h-[250px] absolute z-10 object-contain'>
          <img src='/image1.jpg' className='w-[100%] h-[100%] rounded-md' />
        </div>
        <div className='w-[300px] hover_div flex flex-col justify-end items-center rounded-md h-[250px] absolute z-20' style={{background:'rgba(0,0,0,0.6)'}}>
           <p className='text-white font-700 font-serif text-[30px] pb-4'>E Commerce</p>
        </div>
